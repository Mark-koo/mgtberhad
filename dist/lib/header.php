...
<header class="container">
    ...
    <div class="row justify-content-between align-items-center">
        ...
        <div class="col-auto">
            <a href="/">
                <img class="logo" src="./dist/images/logo-3974bc2a5a5010dc69e3.png" alt="Mega Trustee Berhad" width="4" height="1">
            </a>
        </div>
        <!-- col -->
        <div class="col-auto d-none d-md-block">
            <a class="headerContact" href="tel:+60397794892">
                <img class="icon" src="./dist/images/icon-phone-90f676bd8734f3a88bc2.png" alt="icon"  width="80" height="52">
            ...
            <a class="headerContact"
                ...
                target="_blank">
                <img class="icon" src="./dist/images/icon-map-7b4c6b8658ca3b935c82.png" alt="icon" width="80" height="52">
                <div class="headerContactInfo d-none d-lg-block">
        ...
        <div class="col-auto d-md-none">
            <button id="toggleNav" class="button-icon">
                <img src="./dist/images/icon-menu-6b22fd8b7f813a9317fd.png" alt="navigation button" alt="icon" width="1" height="1">
            </button>
        </div>
    </div>
    <!-- nav & button -->
...
<div id="mobileNav" class="mobileNav">
    ...
    <button id="closeNav" class="button-icon">
        <img src="./dist/images/icon-close-a7d8e964b3cb1127c520.png" alt="close navigation" width="1" height="1">
    </button>
    ...
    <ul class="firstLayer">
        ...
        <li class="gotChildJs <?php if ($url == 'services' || $url == 'contingency-trust' || $url == 'personal-trust' || $url == 'corporate-trust' || $url == 'will-writing' || $url == 'administration-of-estate' || $url == 'interest-scheme' || $url == 'escrow-services') {
            ...
            <a href="/services">
                <span>Services</span>
                <button>
                    <img src="./dist/images/icon-down-5440e2cf9ec894568007.png" alt="icon" width="1" height="1">
                </button>
            </a>
            <ul class="secondLayer">
                <li class="<?php if ($url == 'contingency-trust') {
