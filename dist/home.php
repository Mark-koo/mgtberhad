...
<body>
    ...
    <div class="banner">
        <picture>
            <source srcset="./dist/images/home-banner-800-b2d4284eebe9d416fd31.webp 800w, ./dist/images/home-banner-dcb872bbf668fe8b62e3.webp 1920w" type="image/webp">
            <source srcset="./dist/images/home-banner-800-cece3eb492a7d6042a4e.jpg 800w, ./dist/images/home-banner-32989c7a8dffa5649b31.jpg 1920w" type="image/jpeg">
            <img src="./dist/images/home-banner-32989c7a8dffa5649b31.jpg" alt="KLCC Malaysia">
        </picture>
        ...
        <div class="container">
            <div class="row">
                <div class="image col-12 col-lg-4">
                    <img src="./dist/images/expertise-c24a39f669ae0ae5f602.jpg" alt="service image" width="1" height="1">
                </div>
                    ...
                    <div class="expertiseServices container">
                        <div class="row">
                            <a class="col-12 col-md-6" href="/contingency-trust">
                                <img src="./dist/images/icon-contingency-trust-efd1f9bc1fb6c911b5a4.png" alt="icon" width="1" height="1">
                                <div class="info">
                            ...
                            <a class="col-12 col-md-6" href="/personal-trust">
                                <img src="./dist/images/icon-personal-trust-18ebec0b7af756662525.png" alt="icon" width="1" height="1">
                                <div class="info">
                            ...
                            <a class="col-12 col-md-6" href="/corporate-trust">
                                <img src="./dist/images/icon-corporate-trust-723b9b0ad45db727e706.png" alt="icon" width="1" height="1">
                                <div class="info">
                            ...
                            <a class="col-12 col-md-6" href="/will-writing">
                                <img src="./dist/images/icon-will-writing-31e4c6635ddfe164ba76.png" alt="icon" width="1" height="1">
                                <div class="info">
                                    <h3>Will Writing</h3>
                            ...
                            <a class="col-12 col-md-6" href="/interest-scheme">
                                <img src="./dist/images/icon-interest-scheme-de3d07384d89a7c27ecc.png" alt="icon" width="1" height="1">
                                <div class="info">
                            ...
                            <a class="col-12 col-md-6" href="/escrow-services">
                                <img src="./dist/images/icon-escrow-services-e6b006cb90e655a54ab1.png" alt="icon" width="1" height="1">
                                <div class="info">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <a class="link" href="/about">
                        <img src="./dist/images/icon-right-arrow-834e7ea312db56d0d031.png" alt="icon" width="1" height="1">
                        <span>About Us</span>
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 buttonArea">
                    ...
                    <a class="button" href="tel:+60397794892">
                        <img src="./dist/images/icon-phone-2-5177d17487ce5e73d51f.png" alt="icon" width="1" height="1">
